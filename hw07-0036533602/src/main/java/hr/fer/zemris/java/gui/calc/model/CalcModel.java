...
public interface CalcModel {
  ...
  /**
   * Sets freeze value
   * @param value new freeze value
   */

  void freezeValue(String value);

  /**
   * Does freeze value exists
   * @return true if freeze value exists, else false
   */
  boolean hasFrozenValue();

  /**
   * Invert flag for inverted operations
   */

  void invert();

  /**
   * Checks if calc is inverted
   * @return true if cals is inverted, else false
   */
